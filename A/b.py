...
os.system('clear')
logo ="""
\033[1;92m  d8888b.    .d88b.    .d8888.   .d8888.
\033[1;92m  88  `8D   .8P  Y8.   88'  YP   88'  YP
\033[1;92m  88oooY'   88    88   `8bo.     `8bo.
\033[1;92m  88~~~b.   88    88     `Y8b.     `Y8b.
\033[1;92m  88   8D   `8b  d8'   db   8D   db   8D
\033[1;92m  Y8888P'    `Y88P'    `8888Y'   `8888Y'
\033[1;97m-----------------------------------------------
\033[1;92m➣ PROGRAMER   : MUHAMMAD MUDASAR
\033[1;92m➣ FACEBOOK    : MUHAMMAD MUDASAR
\033[1;92m➣ WHATSAPP    : 03174050946
\033[1;97m-----------------------------------------------"""
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/BOSS-007/Boss/main/server.txt').text
    if to in r:
...
def menu():
    ...
    os.system('clear')
    print logo
    tok = open('/sdcard/.boss.txt', 'r').read()
